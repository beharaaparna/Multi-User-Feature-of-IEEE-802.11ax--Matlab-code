function [th,ra,n_suc_pkts,n_pkts_trans,gamma_ng]= func_new_fpa_nonsat_dyn_cc(m_limit,n,n_sa_stas,Nra_i)
global W_ng;
...
if(Nra_ng~=0)
    [tau_ng,gamma_ng]=find_new_fpa_ng_nonsat_dyn();
else
        tau_ng=0;gamma_ng=0;

end
% [delay1,delay2]=find_moments_mean_alt_drop(W_ng,m_limit,m_ul,gamma_ng,Nra_ng);
[n_suc_pkts,n_pkts_trans]=find_moments_mean_alt_cc(W_ng,m_limit,m_ul,gamma_ng,Nra_ng);
